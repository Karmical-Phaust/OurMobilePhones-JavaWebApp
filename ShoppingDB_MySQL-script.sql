create database if not exists ShoppingDB CHARACTER SET utf8mb4;
...
CREATE TABLE IF NOT EXISTS Accounts(
	...
	`user_phone` varchar(10) NULL, PRIMARY KEY ( `user_mail` ASC ) 
...
CREATE TABLE IF NOT EXISTS Products(
	...
	`product_brand` varchar(100) NULL, PRIMARY KEY ( `product_id` ASC ) 
) CHARACTER SET utf8mb4;
/* SET ANSI_PADDING OFF */
...
CREATE TABLE IF NOT EXISTS Orders(
	...
	`order_discount_code` varchar(20) NULL,
	`order_address` nvarchar(255) NOT NULL, PRIMARY KEY ( `order_id` ASC ) 
) CHARACTER SET utf8mb4;
/* SET ANSI_PADDING OFF */
...
begin
 ...
 SELECT p.product_id ,p.product_name, p.product_des, p.product_price, p.product_img_source, p.product_type, p.product_brand FROM ( 
  ...
  FROM Products p where p.product_type = p_b
...
CREATE TABLE Orders_detail(
	...
	`price_product` double NULL, PRIMARY KEY (`order_id` ASC, `product_id` ASC) 
...
-- account table
INSERT into Accounts (`user_mail`, `password`, `account_role`, `user_name`, `user_address`, `user_phone`) 
VALUES (N'duongdt@fpt.com.vn', N'123', 1, N'Đinh Tùng Dương', N'Đại học FPT', N'0765870407');
-- customer
INSERT into Accounts (`user_mail`, `password`, `account_role`, `user_name`, `user_address`, `user_phone`) 
VALUES (N'duydt@fpt.com.vn', N'456', 1, N'Dao Trong Duy', N'Đại học FPT', N'1234567');
-- me
INSERT into Accounts (`user_mail`, `password`, `account_role`, `user_name`, `user_address`, `user_phone`) 
VALUES (N'andt@fpt.com.vn', N'789', 1, N'Dong Thien An', N'Đại học FPT', N'0845660542');
-- another customer
INSERT into Accounts (`user_mail`, `password`, `account_role`, `user_name`, `user_address`, `user_phone`) 
VALUES (N'blabla@gmail.com', N'FirstTry123', 0, N'Phaust', N'THPT somewhere', N'0952461378');